...
public class AlphabeticalOrder {
    ...
    public static void solve(InputReader sc, PrintWriter pw) {
        ...
        findAlphabeticalOrder(words, n, pw);
    }

    private static void findAlphabeticalOrder(String[] words, int n, PrintWriter pw) {
        ...
        Graph graph = new DirectedGraph(26);
        ...
        for (int i = 0; i < n; i++) {
            ...
            for (int j = i + 1; j < n; j++) {
                ...
                if (diff == -1) {
                    ...
                    if (word1.charAt(diff) != word2.charAt(diff)) {
                        graph.addEdge(word1.charAt(diff) - 'a', word2.charAt(diff) - 'a');
                        inDegree[word2.charAt(diff) - 'a']++;
                    }
                }
    ...
    public static int first(String c, String d) {
        for (int i = 0; i < Math.min(c.length(), d.length()); i++) {
            if (c.charAt(i) != d.charAt(i)) return i;
        }
        return -1;
    }
